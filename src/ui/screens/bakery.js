import { MAX_SPRINKLES, RECIPES, STAGES, STAGE_META } from "../../game/data.js?v=20260512-202000";
import { renderCoinIcon, renderIngredientIcon } from "../components/icons.js?v=20260512-202000";
import { renderCelebrationBurst, renderMascot } from "../components/mascot.js?v=20260512-202000";
import { renderPlayerAvatar } from "../components/player-avatar.js?v=20260512-202000";
import { getStageArtMeta, renderStageArt, STAGE_GALLERY_ORDER } from "../components/stage-art.js?v=20260512-202000";
import {
  clampSprinkles,
  formatOrderCount,
  getMissingPantry,
  ...
  srToBand,
  supportsRecipeSets,
} from "../../game/helpers.js?v=20260512-202000";
import { getSRMode, isVisualMode } from "../../game/sr.js?v=20260512-202000";
import { renderKindergartenBakery } from "../renderers/kindergarten.js?v=20260512-202000";
