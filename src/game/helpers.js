...
import { INGREDIENT_COSTS, MAX_SPRINKLES, RECIPES } from "./data.js?v=20260517-134000";
import { getAllowedQuestionTypes } from "./sr.js?v=20260517-134000";

export { clamp } from "./math.js?v=20260517-134000";
