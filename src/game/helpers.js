...
import { INGREDIENT_COSTS, MAX_SPRINKLES, RECIPES } from "./data.js?v=20260517-141300";
import { getAllowedQuestionTypes } from "./sr.js?v=20260517-141300";

export { clamp } from "./math.js?v=20260517-141300";
