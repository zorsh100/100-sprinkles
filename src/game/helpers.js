...
import { INGREDIENT_COSTS, MAX_SPRINKLES, RECIPES } from "./data.js?v=20260512-110200";
import { getAllowedQuestionTypes } from "./sr.js?v=20260512-110200";

export { clamp } from "./math.js?v=20260512-110200";
