...
import { INGREDIENT_COSTS, MAX_SPRINKLES, RECIPES } from "./data.js?v=20260512-103200";
import { getAllowedQuestionTypes } from "./sr.js?v=20260512-103200";

export { clamp } from "./math.js?v=20260512-103200";
