...
import { INGREDIENT_COSTS, RECIPES } from "./data.js?v=20260510-031800";
import { getAllowedQuestionTypes } from "./sr.js?v=20260510-031800";

export { clamp } from "./math.js?v=20260510-031800";
