...
import { INGREDIENT_COSTS, MAX_SPRINKLES, RECIPES } from "./data.js?v=20260516-214100";
import { getAllowedQuestionTypes } from "./sr.js?v=20260516-214100";

export { clamp } from "./math.js?v=20260516-214100";
