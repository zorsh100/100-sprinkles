...
import { INGREDIENT_COSTS, MAX_SPRINKLES, RECIPES } from "./data.js?v=20260516-231400";
import { getAllowedQuestionTypes } from "./sr.js?v=20260516-231400";

export { clamp } from "./math.js?v=20260516-231400";
